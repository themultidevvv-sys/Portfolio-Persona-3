...
import bgMusic from "./assets/AboutMe.mp3";
...
export default function AboutMe({ mediaMuted = true, sfxMuted = true }) {
  ...
  const taglineText = t("aboutMe.tagline");
  const aboutText = t("aboutMe.aboutText");
  const quickFacts = t("aboutMe.quickFacts");
  ...
  }, [handleBack, openGithub, openSocialHub]);

  return (
    <div id="menu-screen" className="about-root">
      <BackgroundVideo src={bgVideo} muted={mediaMuted} playbackRate={3} />
      ...
      <div className="about-shell">
        <aside className="about-menu">
          <h2 className="about-menu-title">{t("aboutMe.title")}</h2>
          <div className="about-menu-sub">{t("aboutMe.subtitle")}</div>
          <div className="about-menu-hint">{t("aboutMe.controls")}</div>
          <div
            className="about-controls"
            role="list"
            aria-label="About page controls">
            <div className="about-control" role="listitem"></div>
            <div className="about-control" role="listitem"></div>
            <div className="about-control" role="listitem"></div>

            <div className="about-control" role="listitem">
              <span className="about-control-key">ENTER</span>
              <span>{t("aboutMe.openGithub")}</span>
            </div>
            <div className="about-control" role="listitem">
              <span className="about-control-key">L</span>
              <span>{t("aboutMe.openSocialHub")}</span>
            </div>
            <div className="about-control" role="listitem">
              <span className="about-control-key">A/Q/ESC</span>
              <span>{t("aboutMe.goBack")}</span>
            </div>
          </div>
        </aside>
        ...
        <section className="about-panel" ref={panelRef}>
          <div className="about-hero">
            ...
            <div>
              ...
              <div className="about-tagline">{taglineText}</div>
              <p className="about-text">{aboutText}</p>
            </div>
          </div>

          <h3 className="about-section-title">{t("aboutMe.quickFactsTitle")}</h3>
          <ul className="about-facts">
            {Array.isArray(quickFacts) && quickFacts.map((fact) => (
              <li key={fact}>{fact}</li>
            ))}
          </ul>

          <h3 className="about-section-title">{t("aboutMe.linksTitle")}</h3>
